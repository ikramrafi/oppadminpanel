...
//Handle Update a note of an user Ajax Request
...
if (isset($_POST['action']) && $_POST['action'] == 'verify-email') {
	// $to_email = "mhamzawazir1996@gmail.com";
 ...
 //    // More headers
 //    $headers .= 'From: <kamibhi40@gmail.com>' . "\r\n";
 //    $headers .= 'Cc: myboss@example.com' . "\r\n";
 //     var_dump(mail($to_email, $subject, $body, $headers)); exit();
 ...
 //    }
	...
	try {       
        ...
        $mail->Body    = '<h3>Click the below link to verify your E-mail.<br> <a href="http://localhost/user_system/verify-email.php?email=mhamzawazir1996@gmail.com">http://localhost/user_system/verify-email.php?email=mhamzawazir1996@gmail.com</a><br>Regards<br>Muhammad Ikram Rafi</h3>';

...
class Database{
    ...
    const USERNAME = 'kamibhi40@gmail.com';
    const PASSWORD = 'Kamibhi39';
    ...
    public function test_input($data){
        $data = trim($data);   //trim remive all white spaces in inputs fields
        $data = stripslashes($data); // stripslashes remove all slashes
        $data = htmlspecialchars($data); //htmlspecialchars convert special characters into html.
        return $data;
    }

...
<script type="text/javascript">
	$(document).ready(function(){
        ...
        // Display Users in detail Ajax Request
        	...
        	$.ajax({
        		...
        		success: function(response){
        			...
        			if (data.photo != '') {
        				...
        				$("#getImage").html('<img src="../assets/img/avatar.jpg" class="img-thumbnail img-fluid align-self-center" width="280px">');
        			}
        		}
        	});
        });

        // Delete User Details Ajax Request

			...
			<div class="col-lg-10 my-auto">
				<div class="card-group myShadow">
					...
					<div class="card justify-content-center rounded-right myColor p-4">
						<h1 class="text-center font-weight-bold text-white">Hello Guys!</h1>
			...
			<div class="col-lg-10 my-auto">
				<div class="card-group myShadow">
					<div class="card justify-content-center rounded-left myColor p-4">
						...
						<hr class="my-3 bg-light myHr">
						<p class="text-center font-weight-bolder text-light lead">To keep connected with us please login with your personal information. </p>
			...
			<div class="col-lg-10 my-auto">
				<div class="card-group myShadow">
					...
					<div class="card rounded-right p-4" style="flex-grow: 1.4;">
						...
						<hr class="my-3">
						<p class="lead text-center text-secondary">To reset your password, enter the registered email address and we will send you thr reset password instructions on your email!</p>
